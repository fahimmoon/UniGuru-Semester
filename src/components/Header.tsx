...
export const Header: React.FC<{ onMenuClick: () => void }> = ({ onMenuClick }) => {
  ...
  return (
    <header className="bg-linear-to-r from-pak-green to-pak-light-green text-white p-4 shadow-xl relative z-50 rounded-b-[24px] sm:rounded-t-[40px] overflow-hidden">
      {/* Subtle Flag Element */}
